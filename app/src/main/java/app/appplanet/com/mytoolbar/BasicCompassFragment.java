...
/**
 * Created by digivox on 06/06/16.
 */
public class BasicCompassFragment extends Fragment  implements SensorEventListener, LocationListener {
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (event.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
            ...
            System.arraycopy(smoothed, 0, gravity, 0, 3);
    ...
    public void onAccuracyChanged(Sensor sensor, int accuracy) {
        if (sensor.getType() == Sensor.TYPE_MAGNETIC_FIELD
            ...
            Log.d(TAG, "Compass is not accurate!");
        }
    }
}
